  ...
  <div id="main" role="main">
    <div class="container_16 clearfix">
      ...
      <div class="conta">
        <div class="grid_16">
          <?php if ($products) { ?>
          <table class="compare-info tab" border="1">
            <thead>
              <tr>
        ...
        <?php } ?>
            ...
            <tr>
              <td></td>
              <?php foreach ($products as $product) { ?>
              <td><input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button comp" /></td>
              <?php } ?>
            </tr>
            <tr>
              <td></td>
