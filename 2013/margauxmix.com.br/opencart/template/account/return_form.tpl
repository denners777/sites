            ...
            <div id="return-product">
              <div class="content">
                <div class="return-product">
                  ...
                  <li class="return-model clearfix">
                      <label>
                    <span class="required">*</span>
                    <b><?php echo $entry_model; ?></b></label>
                    ...
                    <ul>
                  <li class="return-quantity clearfix">
