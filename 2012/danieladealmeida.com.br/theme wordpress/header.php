...
<script src="<?php echo bloginfo('template_url');?>/assets/js/colorbox/jquery.colorbox-min.js"></script>
<link rel="stylesheet" href="<?php echo bloginfo('template_url');?>/assets/js/colorbox/css/colorbox.css">
...
<!--<script src="assets/js/libs/cufon.js"></script>
        <script type="text/javascript" src="assets/js/libs/Yanone_Kaffeesatz_400.font.js"></script>
...
<!--[if gte IE 9]>
        <style type="text/css">
        .gradient, .active, input[type="button"], input[type="submit"], button {
        filter: none;
        }
        </style>
        <![endif]-->
<header id="header">
  <div class="brilho"> 
    ...
    <div id="MenuTop"> 
      <!-- -->
      <div class="container_16"> <a href="<?php echo get_bloginfo('url')?>">
      ...
      <nav id="NavSocial">
        <div class="container_16">
          <ul>
            <li> <a href="<?php echo get_bloginfo('url') . '/contato';?>">
              <div class="iconSocial ir Contato"></div>
              <span style="font-size: 14px; text-transform: uppercase;">Contato</span> </a> </li>
            <li> <a href="<?php echo get_bloginfo('url').'/consulta';?>">
              <div class="iconSocial ir Consultas"></div>
              <span style="font-size: 14px; margin-right: 20px; text-transform: uppercase;">Consultas</span> </a> </li>
            <li> <a href="http://www.linkedin.com/pub/daniela-de-almeida/2a/1a0/333" target="_blank">
              <div class="iconSocial ir Linkdin"></div>
              <span>Linkedin</span> </a> </li>
            <li> <a href="https://www.facebook.com/clinicadenutricaofuncionaldanieladealmeida" target="_blank">
    ...
    <!--Fim Menu --> 
    <!--fim Topo -->
    <h1 class="container_16" id="TitleH1"></h1>
  </div>
</header>
<div id="posHeader" class=""> &nbsp; </div>
<!--Fim Header --> 
