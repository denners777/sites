...
<section class="full">
  <div class="container_24">
    <div class="grid_5">
      <div class="icon-princ logomarca"></div>
    </div>
    <div class="grid_19">
...
<?php 			
	  $args = array('post_type' => 'conteudo', 'cat_content' => 'logomarca');
...
?>
  ...
  ?>
      <a href="<?php echo wp_get_attachment_url(get_post_thumbnail_id($post-> ID)); ?>" title="<?php the_title(); ?>" rel="<?php echo 'Gal'.$post-> ID; ?>" class="lightbox">
        <figure>
