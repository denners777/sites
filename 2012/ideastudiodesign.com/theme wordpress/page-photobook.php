...
<section class="full">
  <div class="container_24">
    <div class="grid_5">
      <div class="icon-princ photobook"></div>
    </div>
    <div class="grid_19">
...
<?php 			
	  $args = array('post_type' => 'conteudo', 'cat_content' => 'photobook', 'orderby' => 'title', 'order' => 'ASC');
...
?>
  ...
  ?>
      <a href="#<?php echo 'Gal'.$post-> ID; ?>" title="<?php the_title(); ?>" class="thumb" >
        ...
        <figcaption class="teste"><?php the_title(); ?></figcaption>
      </a> 
