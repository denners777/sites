...
<div role="main" id="main">
  <div class="container_12 clearfix" id="galerias">
    <div class="col01">
      <h1>MODA<span><img src="<?php echo bloginfo('template_url');?>/assets/img/traco_title.png" width="147" height="12" /></span></h1>
      <div class="grid_2">
        <nav class="menu_portifolio">
          <ul>
            <?php
		 	$Cont = 0;
			$args = array( 'post_type' => 'moda', 'order' => 'ASC' );
      ...
      <?php
			$args = array( 'post_type' => 'moda', 'order' => 'ASC', 'posts_per_page' => 1 );
			$loop = new WP_Query( $args );
			while ( $loop->have_posts() ) : $loop->the_post();
			$images = attachments_get_attachments();
         ?>
