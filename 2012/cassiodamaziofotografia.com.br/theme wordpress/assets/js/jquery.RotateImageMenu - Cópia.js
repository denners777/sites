...
h2 = new Array ("<a href='http://teste.cassiodamazio.com.br/olhares'>OLHARES</a>", 
				"<a href='http://teste.cassiodamazio.com.br/espetaculos'>ESPETÁCULOS</a>", 
				"<a href='http://teste.cassiodamazio.com.br/moda'>MODA</a>", 
				"<a href='http://teste.cassiodamazio.com.br/produtos'>PRODUTOS</a>");
	var contador = 0;
	...
	function loop(acao){
		...
		$('#rm_container h2').fadeOut(function(){
			$('#rm_container h2').html(h2[contador]);
		}).fadeIn('slow')
	}