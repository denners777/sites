...
<title>Adicionar novo destaque | Painel &rsaquo; Mello&amp;Madruga</title>
...
<body onload="menu_ctrl('destaques','novo')">
	<div id="painel">
        <h1><small>Painel </small>Mello&amp;Madruga</h1>
        <?php include 'menu.php'; ?>
        <div id="cont">
        	<h2>Adicionar novo destaque</h2>
            <form action="destaques-acoes.php?a=n" method="post" id="destaques_novo">
                ...
                <fieldset class="post destaques">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                            	<select name="gde1" id="gde1" onchange="dest_foto_carrega('gde1','1')">
                        ...
                        <tr>
                            ...
                            <td>
                            	<select name="gde2" id="gde2" onchange="dest_foto_carrega('gde2','1')">
                                	<option value="">Escolha</option>
                                	<?php destaques_rel(''); ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                            	<select name="peq1" id="peq1" onchange="dest_foto_carrega('peq1','2')">
                                	<option value="">Escolha</option>
                                	<?php destaques_rel(''); ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                            	<select name="peq2" id="peq2" onchange="dest_foto_carrega('peq2','2')">
                                	<option value="">Escolha</option>
                                	<?php destaques_rel(''); ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                            	<select name="peq3" id="peq3" onchange="dest_foto_carrega('peq3','2')">
                                	<option value="">Escolha</option>
                                	<?php destaques_rel(''); ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                            	<select name="peq4" id="peq4" onchange="dest_foto_carrega('peq4','2')">
                                	<option value="">Escolha</option>
                                	<?php destaques_rel(''); ?>
                                </select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td><input type="radio" name="atual" id="atual_n" value="N" checked="checked" /> <label for="atual_n">Não</label> <input type="radio" name="atual" id="atual_s" value="S" /> <label for="atual_s">Sim</label></td>
                        </tr>
                        <tr>
