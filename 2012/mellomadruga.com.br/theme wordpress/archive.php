...
<h1 class="page-title"><?php wp_title("",true); ?>'S ARCHIVE</h1>
...
?>
                                           ...
                                           por <?php the_author_posts_link(); ?> em <a href="<?php echo get_day_link($arc_year, $arc_month, $arc_day); ?>"><?php the_time( get_option( 'date_format' ) ); ?></a>
